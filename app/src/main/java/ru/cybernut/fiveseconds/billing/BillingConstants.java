...
public final class BillingConstants {
    // SKUs for our products: question_pack_1 and question_pack_2
    public static final String SKU_QUESTION_PACK_1 = "question_pack_1";
    public static final String SKU_QUESTION_PACK_2 = "question_pack_2";

    // SKU for our subscription (now none)
//    public static final String SKU_GOLD_MONTHLY = "gold_monthly";
//    public static final String SKU_GOLD_YEARLY = "gold_yearly";

    private static final String[] IN_APP_SKUS = {SKU_QUESTION_PACK_1, SKU_QUESTION_PACK_2};
